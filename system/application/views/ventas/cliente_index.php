                    ...
                    <table class="fuente8 display" id="table-cliente">
                        ...
                        <thead>
                            <tr class="cabeceraTabla">
                                <td style="width:10%" data-orderable="true">AGENTE RETENEDOR</td>
                ...
                <form id="formCliente" method="POST">
                    ...
                    <div class="modal-body panel panel-default">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-2 col-md-2 col-lg-2">                              
                                <label for="agente_retenedor">&nbsp; &nbsp; Agente Retenedor(*)</label><br>
                                <label for="agente_retenedor">Si</label>
                                <input type="radio" class="agente_retencion1" name="agente_retencion" id="agente_retencion" value="1" style="position: relative; width: 40px; height: 40px; top: 1px" />
                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp;                          
                                <input type="radio" class="agente_retencion2" name="agente_retencion" id="agente_retencion" value="0" style="position: relative; width: 40px; height: 40px; top: 1px"/>
                                <label for="agente_retenedor">No</label>
                            </div>
            ...
            $.ajax({
                ...
                success: function(data){
                    if (data.match == true) {
                        ...
                        //alert(info.agente_retencion);
                        var agente_retencion = parseInt(info.agente_retencion);
                        if (agente_retencion === 1) {
                            $(".agente_retencion1").prop("checked", true);
                        } else if (agente_retencion === 0) {
                            $(".agente_retencion2").prop("checked", true);
                        }
                            ...
                            if (data.match == true){
                                ...
                                if (data.tipo_cliente == 0){ // NATURAL
                                    ...
                                    $("#razon_social").val(info.result.razon_social);
                                     //#########################################
                                    var documento = info.result.documento;
                                    if (documento === "RUC") {
                                        documento = 6;
                                        $("#tipo_documento").val(documento);    
                                    }
                                    if (info.result.retencion === "NO") {
                                        $(".agente_retencion2").prop("checked", true);
                                    }
                                    if (info.result.retencion === "SI") {
                                        $(".agente_retencion1").prop("checked", true);
                                    }
