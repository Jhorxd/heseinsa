            ...
            <form method="post" id="form-mail">
                <div class="contenido" style="width: 100%; margin: auto; height: auto; overflow: auto;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2 col-md-2 col-lg-2">
                            <div class="form-group">
                                <img src="<?=base_url();?>images/cdr.png" style="width: 22px"/>
                                <input type="hidden" value="false" name="adj-cdr_hidden">
                                <input class="form-control" id="adj-cdr" name="adj-cdr" type="checkbox" value="1" style="display: none;">
                                <div class="Switch Round On fib" style="vertical-align:top;margin-left:10px;"><div class="Toggle"></div></div>
                            </div>
                        </div>
                    </div>
    ...
    $(document).ready(function(){
        ...
        $(".btn-sendMail").click(function(){
            ...
            $.ajax({
                url:url,
                type:"POST",
                data:{ codigo: codigo, destinatario: destinatario, asunto: asunto, mensaje: mensaje, documento: documento, ticket: ticket, a4: a4, xml: xml, cdr: cdr},
                dataType:"json",
                error:function(data){
                },
                beforeSend: function(){
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if (data.match == true){
                    ...
                    $("#asunto").val("N*OC:   / ENVÍO DE FACTURA HESEINSA RUC: 20128246372 / COMPROBANTE "+info.serie + " - " + info.numero +" OSA-ERP");
