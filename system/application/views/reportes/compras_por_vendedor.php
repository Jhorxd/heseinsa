    ...
    $("#reporteExcelVendedor").click(function(){
      if($('#fecha_inicio').val() == "" || $('#fecha_fin').val() == ""){
        ...
        if (startDate > endDate){
          ...
          location.href = "<?=base_url();?>index.php/reportes/compras/filtroVendedorExcel/"+fechaIF;
        }
      }
    });
    ...
    $("#reporteExcelVendedorGeneral").click(function(){
      if($('#fecha_inicio').val() == "" || $('#fecha_fin').val() == ""){
        ...
        if (startDate > endDate){
          ...
          location.href = "<?=base_url();?>index.php/reportes/compras/filtroVendedorExcelGeneral/"+fechaIF;
        }
      }
    });
    ...
    $("#reporteExcelVendedorDet").click(function(){
      if($('#fecha_inicio').val() == "" || $('#fecha_fin').val() == ""){
        ...
        if (startDate > endDate){
          ...
          location.href = "<?=base_url();?>index.php/reportes/compras/filtroVendedorExcelDet/"+idVendedor+"/"+fechaIF;
        }
      }
    });
  });
...
<div id="pagina">
    ...
    <div align="center">
    <div id="tituloForm" class="header">REPORTES DE COMPRAS POR VENDEDOR</div>
    <div id="frmBusqueda">
      ...
      <table class="fuente8 display" cellspacing="0" cellpadding="3" border="0" id="resumen">
        <thead>
          <tr class="cabeceraTablaResultado"><th colspan="3">Reporte de compras por vendedor desde <?php echo $fecha_inicio; ?> hasta el <?php echo $fecha_fin; ?></th></tr>
      ...
      <script type="text/javascript">
        ...
        function drawColumnChart() {
          ...
          var options = {
            title: 'Comparativo Compras Mes a Mes',
          };
      ...
      function drawBarChart() {
        ...
        var options = {
          title: 'Comparativo Compras Anuales',
