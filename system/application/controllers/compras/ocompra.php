  ...
  ## Dev: RC -> End
    ...
    public function nueva_ocompra($tipo_oper = 'C',$sucursal=''){
        /* :::: SE CREA LA SESSION :::*/
         ...
         $numeroeditar = 1; 
        $this->session->set_userdata('numeroeditar', $numeroeditar);
    ...
    public function insertar_ocompra(){
        ...
        $filter->OCOMC_NombreComprador= $this->input->post('comprador');;
    ...
    {   
        ...
        $descuento100 = $datos_ocompra[0]->OCOMC_descuento100;
        $comprador = $datos_ocompra[0]->OCOMC_NombreComprador;
        $igv100 = $datos_ocompra[0]->OCOMC_igv100;
       ...
       // $nombreComprador='';
        ...
        $data['comprador'] = $nombreComprador;
    ...
    public function insertar_pedido($codigoOC){
        ...
        if (count($detalle) > 0) {
            ...
            if ( $gocompra == true){
                ...
                $filterOC->OCOMC_NombreComprador="";
