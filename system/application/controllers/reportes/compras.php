...
class Compras extends Controller {
    ...
    public function excel_producto_por_vendedor($vendedor = "", $fechai = NULL, $fechaf = NULL)
    {
        ...
        foreach ($vendedores as $key => $value) {
            ...
            $this->excel->setActiveSheetIndex($hoja)->mergeCells('A3:H3')->setCellValue("A3", "REPORTE DE COMPRAS POR PRODUCTO SEGUN VENDEDOR. DESDE $fechai HASTA $fechaf");
            ...
            $productosInfo = $this->compras_model->excel_reporte_por_producto_vendedor($f_ini, $f_fin, $vendedor);
            ...
            $filename = "Compras por vendedor ".date('Y-m-d').".xls";
    ...
    public function filtroVendedor() {
        ...
        if (isset($_POST['reporte'])) {
            ...
            $data['resumen'] = $this->compras_model->compras_por_vendedor_resumen($data['fecha_inicio'], $data['fecha_fin']);
            $data['mensual'] = $this->compras_model->compras_por_vendedor_mensual($data['fecha_inicio'], $data['fecha_fin']);
            $data['anual'] = $this->compras_model->compras_por_vendedor_anual($data['fecha_inicio'], $data['fecha_fin']);
        }
    ...
    public function filtroVendedorExcel($fechai = NULL, $fechaf = NULL) {
        ...
        $f_fin = ($fechaF == NULL) ? date('Y-m-d') : "$fechaf";
            ...
            $resumen = $this->compras_model->compras_por_vendedor_resumen($f_ini, $f_fin);
            $mensual = $this->compras_model->compras_por_vendedor_mensual($f_ini, $f_fin);
            $anual = $this->compras_model->compras_por_vendedor_anual($f_ini, $f_fin);
        
        $this->load->library('Excel');
        
        $this->excel->setActiveSheetIndex(0);
        $this->excel->getActiveSheet()->setTitle('Compras Por Vendedor');
        ...
        $filename = "Compras De Vendedores ".date('Y-m-d').".xls"; //save our workbook as this file name
    ...
    public function filtroVendedorExcelDet($vendedor = "0", $fechai = NULL, $fechaf = NULL) {
        ...
        ###########################################################################
            ...
            $this->excel->setActiveSheetIndex($hoja)->mergeCells("A3:K3")->setCellValue("A3", "COMPRAS POR VENDEDOR DESDE $f_ini HASTA $f_fin");
            ...
            foreach ($listaVendedores as $indice => $data) {
                ...
                $resumen = $this->compras_model->compras_por_vendedor_general_suma($data->PERSP_Codigo, $f_ini, $f_fin);
                $detalle = $this->compras_model->compras_por_vendedor_detallado($data->PERSP_Codigo, $f_ini, $f_fin);
        ...
        ###########################################################################
            $productosInfo = $this->compras_model->compras_por_producto_de_vendedor($f_ini, $f_fin);
            ...
            $this->excel->createSheet($hoja);
            $this->excel->setActiveSheetIndex($hoja); //Seleccionar la pestaña deseada
            $this->excel->getActiveSheet()->setTitle('Compras por producto'); //Establecer nombre
            ...
            $this->excel->setActiveSheetIndex($hoja)->mergeCells('A3:'.$colE.'3')->setCellValue("A3", "REPORTE DE COMPRAS POR PRODUCTO SEGUN VENDEDOR. DESDE $f_ini HASTA $f_fin");
        ...
        ###########################################################################
            $marcasInfo = $this->compras_model->compras_por_marca_de_vendedor($f_ini, $f_fin);
            ...
            $this->excel->createSheet($hoja);
            $this->excel->setActiveSheetIndex($hoja); //Seleccionar la pestaña deseada
            $this->excel->getActiveSheet()->setTitle('Compras por marca del vendedor'); //Establecer nombre

            $this->excel->getActiveSheet()->getStyle('A1:'.$colE.'2')->applyFromArray($estiloTitulo);
            $this->excel->getActiveSheet()->getStyle('A3:'.$colE.'3')->applyFromArray($estiloColumnasTitulo);

            $this->excel->setActiveSheetIndex($hoja)->mergeCells('A1:'.$colE.'2')->setCellValue('A1', $_SESSION['nombre_empresa']);
            $this->excel->setActiveSheetIndex($hoja)->mergeCells('A3:'.$colE.'3')->setCellValue("A3", "REPORTE DE COMPRAS POR MARCA SEGUN VENDEDOR. DESDE $f_ini HASTA $f_fin");
        ...
        $filename = "Compras por vendedor ".date('Y-m-d').".xls"; //save our workbook as this file name
        header("Content-Type: application/vnd.ms-excel");
        header("Content-Disposition: attachment;filename=$filename");
        header("Cache-Control: max-age=0"); //no cache
        $objWriter = PHPExcel_IOFactory::createWriter($this->excel, 'Excel5');
    ...
    public function filtroVendedorExcelGeneral($fechai = NULL, $fechaf = NULL) {
        ...
        $this->excel->setActiveSheetIndex(0)->mergeCells("A3:H3")->setCellValue("A3", "COMPRAS POR VENDEDOR DESDE $f_ini HASTA $f_fin");
        ...
        foreach ($listaVendedores as $indice => $data) {
            ...
            $detalle = $this->compras_model->compras_por_vendedor_general($data->PERSP_Codigo, $f_ini, $f_fin);
            ...
            if ($detalle != NULL){
                foreach($detalle as $indice => $valor){
                    ...
                    if ($numeroS == 1){
                        ...
                        $this->excel->setActiveSheetIndex(0)->setCellValue("H$lugar", 'COMPRAS - NOTAS DE CREDITO');
                        $lugar++;
                    }
        ...
        $filename = "Compras por Vendedor General ".date('Y-m-d').".xls"; //save our workbook as this file name
        header("Content-Type: application/vnd.ms-excel");
        header("Content-Disposition: attachment;filename=$filename");
        header("Cache-Control: max-age=0"); //no cache
        $objWriter = PHPExcel_IOFactory::createWriter($this->excel, 'Excel5');
    ...
    public function filtroProveedor() {
        ...
        $this->layout->view('reportes/ventas_por_proveedor', $data);
    }
    ...
    public function resumen_compras_detallado($fechai = NULL, $fechaf = NULL) {
        ...
        $resumen = $this->compras_model->resumen_compras_detallado($f_ini, $f_fin);
    ...
    public function filtroTienda() {
        ...
        if (isset($_POST['reporte'])) {
            $data['fecha_inicio'] = $_POST['fecha_inicio'];
            $data['fecha_fin'] = $_POST['fecha_fin'];
            $data['resumen'] = $this->compras_model->compras_por_tienda_resumen($data['fecha_inicio'], $data['fecha_fin']);
            $data['mensual'] = $this->compras_model->compras_por_tienda_mensual($data['fecha_inicio'], $data['fecha_fin']);
            $data['anual'] = $this->compras_model->compras_por_tienda_anual($data['fecha_inicio'], $data['fecha_fin']);
        }
    ...
    public function filtroMarca() {
        ...
        if (isset($_POST['reporte'])) {
            $data['fecha_inicio'] = $_POST['fecha_inicio'];
            $data['fecha_fin'] = $_POST['fecha_fin'];
            $data['resumen'] = $this->compras_model->compras_por_marca_resumen($data['fecha_inicio'], $data['fecha_fin']);
            $data['mensual'] = $this->compras_model->compras_por_marca_mensual($data['fecha_inicio'], $data['fecha_fin']);
            $data['anual'] = $this->compras_model->compras_por_marca_anual($data['fecha_inicio'], $data['fecha_fin']);
        }
    ...
    public function filtroMarcaExcel($fechai = NULL, $fechaf = NULL) {
        ...
        $f_fin = ($fechaF == NULL) ? date('Y-m-d') : "$fechaf";
            ...
            $resumen = $this->compras_model->compras_por_marca_resumen($f_ini, $f_fin);
            $mensual = $this->compras_model->compras_por_marca_mensual($f_ini, $f_fin);
            $anual = $this->compras_model->compras_por_marca_anual($f_ini, $f_fin);

        $this->load->library('Excel');
        $hoja = 0;
        $this->excel->setActiveSheetIndex($hoja);
        $this->excel->getActiveSheet()->setTitle('COMPRAS Por MARCA');
        ...
        ###########################################################################
            ...
            $this->excel->setActiveSheetIndex($hoja)->mergeCells('A1:E2')->setCellValue('A1', $_SESSION['nombre_empresa']);
            $this->excel->setActiveSheetIndex($hoja)->mergeCells("A3:E3")->setCellValue("A3", "REPORTE DE COMPRAS POR MARCA DESDE $f_ini HASTA $f_fin");
        ...
        ###########################################################################
            ...
            $this->excel->createSheet($hoja);
            $this->excel->setActiveSheetIndex($hoja); //Seleccionar la pestaña deseada
            $this->excel->getActiveSheet()->setTitle('Compras por marca Segun Vendedor'); //Establecer nombre
        ...
        $filename = "Compras por MARCA desde ".$f_ini." hasta ".$f_fin.".xls"; //save our workbook as this file name
    ...
    public function filtroFamilia() {
        ...
        if (isset($_POST['reporte'])) {
            $data['fecha_inicio'] = $_POST['fecha_inicio'];
            $data['fecha_fin'] = $_POST['fecha_fin'];
            $data['resumen'] = $this->compras_model->compras_por_familia_resumen($data['fecha_inicio'], $data['fecha_fin']);
            $data['mensual'] = $this->compras_model->compras_por_familia_mensual($data['fecha_inicio'], $data['fecha_fin']);
            $data['anual'] = $this->compras_model->compras_por_familia_anual($data['fecha_inicio'], $data['fecha_fin']);
        }
    ...
    public function filtroFamiliaExcel($fechai = NULL, $fechaf = NULL) {
        ...
        $f_fin = ($fechaF == NULL) ? date('Y-m-d') : "$fechaf";
            ...
            $resumen = $this->compras_model->compras_por_familia_resumen($f_ini, $f_fin);
            $mensual = $this->compras_model->compras_por_familia_mensual($f_ini, $f_fin);
            $anual = $this->compras_model->compras_por_familia_anual($f_ini, $f_fin);
        
        $this->load->library('Excel');
        
        $this->excel->setActiveSheetIndex(0);
        $this->excel->getActiveSheet()->setTitle('Compras Por Familia');
        ...
        $this->excel->getActiveSheet()->getStyle("A3:E3")->applyFromArray($TipoFont2);
        $this->excel->getActiveSheet()->getStyle("A3:E3")->applyFromArray($style2);
        $this->excel->setActiveSheetIndex(0)->mergeCells("A3:E3")->setCellValue("A3", "REPORTE DE COMPRAS POR FAMILIA DESDE $f_ini HASTA $f_fin");
        ...
        $filename = "Compras por Familia desde ".$f_ini." hasta ".$f_fin.".xls"; //save our workbook as this file name
    ...
    public function filtroProducto() {
        ...
        if (isset($_POST['reporte'])) {
            $data['fecha_inicio'] = $_POST['fecha_inicio'];
            $data['fecha_fin']  = $_POST['fecha_fin'];
            $data['resumen']    = $this->compras_model->compras_por_producto_resumen($data['fecha_inicio'], $data['fecha_fin']);
            $data['mensual']    = $this->compras_model->compras_por_producto_mensual($data['fecha_inicio'], $data['fecha_fin']);
            $data['anual']      = $this->compras_model->compras_por_producto_anual($data['fecha_inicio'], $data['fecha_fin']);
        }
    ...
    public function Producto_stock() {
        ...
        $listado_productos = $this->compras_model->producto_stock();
    ...
    public function filtroDiario() {
        ...
        if (isset($_POST['reporte'])) {
            $data['fecha_inicio'] = $_POST['fecha_inicio'];
            $data['fecha_fin'] = $_POST['fecha_fin'];
            $data['resumen'] = $this->compras_model->compras_por_dia($data['fecha_inicio'], $data['fecha_fin']);
        }
    ...
    public function ventasDiarias_pdf($date, $user){
        ...
        $dailySalesReceipt = $this->compras_model->ventasDiarioC($date, $compania);
        $num = 95;
        $db_data1 = array();
        ...
        $tipo_doc = "";
        $dailySalesReceipt = $this->compras_model->ventasDiarioC($date, $compania);
        $dailySalesNote = $this->compras_model->ventasDiarioN($date, $compania);
        $totalDaily = $this->compras_model->ventasTotal($date, $compania);
        $lista = $this->compras_model->ventas_diarios($tipo_doc, $fecha_generacion);
        ...
        $this->pdf->MultiCell(0, 1, utf8_decode("COMPRA DEL DIA"), 0, 'C', false);
        $this->pdf->Ln(1);
    ...
    public function comprasDiarias($date, $user)
	{
        $compania = $this->somevar['compania'];
    ...
    public function ventasdiario($tipo = 'F') {
        ...
        $data['lista'] = $this->compras_model->ventas_diarios($tipo, $hoy);
        $data['fecha'] = $hoy;
    ...
    public function ejecutarAjax(){
        ...
        $lista = $this->compras_model->registro_compras($tipo_oper, $tipo, $mes, $anio); 
        $RetornarTable = "";
    ...
    public function ventasdiario_fecha($tipo = 'F', $hoy) {
        ...
        $data['tipo_docu'] = $tipo;
        $data['titulo_tabla'] = "Ventas del dia";
        $data['lista'] = $this->compras_model->compras_diarios($tipo, $hoy);
        $data['fecha'] = $hoy;
    ...
    public function ventas_pdf($tipo_doc = "F", $hoy) {
        ...
        $lista = $this->compras_model->compras_diarios($tipo_doc, $hoy);
    ...
    public function registro_ventas_pdf($tipo_oper, $tipo_doc = "F", $fecha1, $fecha2) {
        ...
        $lista = $this->compras_model->registro_compras($tipo_oper, $tipo_doc, $fecha1, $fecha2);
        $this->cezpdf = new Cezpdf('a4', 'landscape');
     ...
     //AQUI EXCEL NUEVO
    public function resumen_compras_mensual($tipo_oper = "C", $tipo = "", $fecha1 = "", $fecha2 = "", $forma_pago = "", $vendedorOrStore = "", $moneda = "", $consolidado="") {
        ...
        if (isset($vendedorOrStore) && $vendedorOrStore!="" && $vendedorOrStore!="-") {
            $vendedorOrStore = $vendedorOrStore;
        }else{
            $vendedorOrStore = "";
        }
        ...
        if($tipo_oper == "C"){
            $filter->vendedor       = $vendedorOrStore;
        }else{
            $filter->almacen       = $vendedorOrStore;
        }
        $filter->moneda         = $moneda;
        $filter->consolidado    = $consolidado;

        $resumen = $this->compras_model->resumen_compras_mensual($filter);
        ...
        $this->excel->setActiveSheetIndex(0)->setCellValue("Q$lugar", ($tipo_oper == 'C')?"Almacen":"Vendedor");
        $this->excel->getActiveSheet()->getStyle("A$lugar:Q$lugar")->applyFromArray($estiloColumnasTitulo);
        ...
        if ($resumen != NULL){
            ...
            foreach($resumen as $indice => $valor){
                ...
                ->setCellValue("Q$lugar", ($tipo_oper == "C")? $valor->ALMAC_Descripcion:$valor->vendedor);
                if ($indice % 2 == 0)
...
#REPORTE DE GANANCIA
    public function ganancia($value='')
    {
        ...
        $ganancia_global    = $this->compras_model->ganancia_global_compras($filter);
    ...
    public function datatable_ganancia(){
        ...
        $lista_ganancia = $this->compras_model->reporte_ganancia_compras($filter);
    ...
    public function gananciaExcel($codigo, $companias, $fecha,$moneda) {
        ...
        $total_util  = 0;
        $total_porc_util = 0;
        $lista_ganancia = $this->compras_model->reporte_ganancia_old_compras($producto, human_to_mysql($f_ini), human_to_mysql($f_fin), $companias,$moneda);
...
#FIN GANANCIA
    ...
    public function descargarExcel($fechaini, $fechafin){
        $resultado = $this->compras_model->compras_por_dia($fechaini, $fechafin);
        ...
        ###########################################################################
            ...
            foreach ($resultado as $value) {
                ...
                $pago = ( $value['FORPAP_Codigo'] == 1 ) ? $value['VENTAS'] : $this->compras_model->total_pagos($value['CUE_Codigo'], $fechaini, $fechafin);
        ...
        ###########################################################################
            ...
            $resumen = $this->compras_model->resumen_compras($fechaini, $fechafin);
        ...
        ###########################################################################
            ...
            $resumen = $this->compras_model->resumen_compras_detallado($fechaini, $fechafin);
    ...
    public function registro_ventas($tipo_oper, $tipo = 'F', $fecha1 = '', $fecha2 = '') {
        ...
        if ($tipo_oper == 'C'){
            ...
            $data['cboAlmacen']    =$this->almacen_model->getAlmacens();
        }
    ...
    public function registro_ventas_table(){
        ...
        $vendedorOrStore       = $this->input->post('vendedorOrStore');
        ...
        $info = $this->compras_model->resumen_compras_mensual($filter);
    ...
    ********************************************************/
    ...
    public function concar($tipo_oper = "C", $tipo = "", $fecha1 = "", $fecha2 = "", $forma_pago = "", $vendedor = "", $moneda = "", $consolidado=""){
        ...
        $reporte = $this->compras_model->concar_model($filter);
                ...
                foreach ($reporte as $key => $row) {
                    ...
                    switch ($tipo_doc){
                        case 'F':
                            $TipoDetalle="FT";
                            $cuenta = "121201";
                            $detalle_comprobante = $this->compras_model->detalles_concar_comprobantes($codigo);
                        ...
                        case 'NC':
                            $TipoDetalle = "NA";
                            $detalle_comprobante = $this->compras_model->detalle_concar_nota($codigo);
    ...
    {
        // $rows = $this->compras_model->reporte_productos_masVendidos();
        // var_dump($rows);
        $this->load->library('layout', 'layout');
    ...
    public function masVendidosAjax()
    {
        ...
        $rows = $this->compras_model->reporte_productos_masVendidos($filter);
        $tachado1 = ""; $tachado2 = "";
    ...
    public function masVendidosExcel($typeDoc=0, $feha1=0, $fecha2=0, $formaPago=0, $vendedor=0, $moneda=0)
    {
        ...
        $lista = $this->compras_model->reporte_productos_masVendidos($filter);
...
//REPORTE POR PRODUCTOS
    public function reportes($tipo_oper=''){
        $anios                      = $this->compras_model->anios_para_reportes('V');
    ...
    public function productos_vendidos_general()
    {
        ...
        $reporte_result = $this->compras_model->productos_vendidos_general($filter, false);
        $records = array();
    ...
    public function productos_vendidos_detalle()
    {
        ...
        $reporte_result = $this->compras_model->productos_vendidos_detalle($filter, false);
        $records = array();
        $cantidad_total = 0;
        $total_global   = 0;
        $simbolo        = "S/";
    ...
    public function productos_vendidos_mensual()
    {
        ...
        $reporte_result = $this->compras_model->ventas_producto_mes($filter, false);
        $records    = array();
        $total_mes  = array();
    ...
    public function productos_vendidos_anual()
    {
        ...
        $reporte_result = $this->compras_model->ventas_producto_anio($filter, false);
        $records    = array();
        $total_anio  = array();
...
#VENTAS POR CLIENTE
    ...
    public function datatable_ventas_clientes($tipo_oper = '', $tipo_docu = ''){
        ...
        $filter->moneda         = $this->input->post("moneda");
        $listado_comprobantes   = $this->compras_model->ventas_reporte_rango($filter);
        ...
        unset($filter->start);
        unset($filter->length);
        $recordsTotal = $this->compras_model->ventas_reporte_rango($filter);
        $filter->acumulado = 1;
        $recordsChats= $this->compras_model->ventas_reporte_rango($filter);
    ...
    public function reporte_excel_producto($cliente, $fi ,$ff, $producto)
    {
            ...
            $filter->fecha_inicio   = $fi;
            $filter->fecha_fin      = $ff;
            $listado_comprobantes   = $this->compras_model->ventas_cliente_producto($filter);
...
public function registro_ventas_pdf2($tipo_oper, $tipo_doc = "F", $fecha1, $fecha2, $forma_pago="", $consolidado=0, $sucursal='') 
    {
        ...
        $info = $this->compras_model->resumen_compra_mensual($filter);
