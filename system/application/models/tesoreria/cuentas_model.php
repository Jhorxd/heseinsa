...
class Cuentas_model extends Model {
    ...
    public function getCuentas($filter = NULL){
        ...
        $sql = "SELECT 
                    ...
                    p.PAGC_FechaOper, b.BANC_Nombre, l.LINC_Descripcion
                    
                    FROM cji_cuentas c
                    INNER JOIN cji_comprobante cp ON cp.CPP_Codigo = c.CUE_CodDocumento
                    LEFT JOIN cji_linea l ON cp.rubro_id = l.LINP_Codigo
                    LEFT JOIN cji_cuentaspago cpp ON c.CUE_Codigo = cpp.CUE_Codigo
                    LEFT JOIN cji_pago p ON cpp.PAGP_Codigo = p.PAGP_Codigo
                    LEFT JOIN cji_banco b ON cpp.BANP_Codigo = b.BANP_Codigo
