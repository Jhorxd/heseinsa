...
class Usuario_model extends Model {
	...
	//?Método para guardar los datos de usuario al iniciar sesion.
	...
	//?Método para listar todas las sesiones almacenadas en la base de datos.
	public function listar_sesiones(){
		//? consulta a la base de datos
		$sql = "SELECT * FROM cji_sesion order by SESIP_Codigo desc limit 30";
		//? ejecucion
		$query = $this->db->query($sql);
		$data = NULL;
