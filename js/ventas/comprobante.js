...
function abrir_cdr_envioSunat(codigo) {
    url = base_url + "index.php/ventas/comprobante/consultarRespuestaCdrsunat/" + codigo;
    $.ajax({
        type: "POST",
        url: url,
        data: codigo,
...
jQuery(document).ready(function () {
    ...
    $("#grabarComprobanteByAdmin").click(function () {
    ...
    function modificarComprobante(codigo) {

        url = base_url+"index.php/ventas/comprobante/modificarComprobanteAdmin/"+ codigo;
    ...
    function anulacionInterna(codigo) {

        let motivo = "Correcion del administrador";
        let url = base_url+"index.php/ventas/comprobante/comprobante_eliminar";
    ...
    function modificacionAdmin(comprobanteId){
        return modificarComprobante(comprobanteId)
        .then(() => {
            return anulacionInterna(comprobanteId)
        }).catch((error) => {
...
function editar_comprobante_admin(comprobante, statusAdmin) {
    //alert(base_url)
    location.href = base_url + "index.php/ventas/comprobante/comprobante_editar/" + comprobante + "/" + tipo_oper + "/" + tipo_docu + "/" + statusAdmin;
}
